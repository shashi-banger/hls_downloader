...
class GenericDownloader(object):
    def __init__(self, inp_url, dest_seg_dir, dest_rec_dir, collection):
        ...
        if p.is_variant:
            ...
            if nearest_v is not None:
                ...
                self.pl_downloader = PlaylistReader(nearest_v.uri, dest_seg_dir, dest_rec_dir, collection)
            else:
...
if __name__ == "__main__":
    ...
    GenericDownloader(options.inp_url, options.dest_segment_dir, options.dest_recording_dir, options.collection)
